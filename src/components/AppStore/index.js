...
class AppStore extends Component {
  state = {
    searchInput: '',
    activeTabId: tabsList[0].tabId, // Initially "Social" tab is active
  }
  ...
  getActiveTabApps = (apps, tabId) => apps.filter(app => app.category === tabId)
  ...
  render() {
    ...
    const filteredApps = this.getActiveTabApps(searchResults, activeTabId)
